...
| **Queue (basis client)** | **`nats_basis`** driver from **1.4.0+** ([QUEUE.md](QUEUE.md)); legacy **`nats`** driver unchanged. |
...
### Queue on the basis client (1.4.0+)
...
- [FAQ](FAQ.md)
- [Roadmap](../ROADMAP.md) — indicative v2.x themes and status
